...
const createBook = async function (req, res) {
    try {
        ...
        return res.status(201).send({ status: true, message: "Success", data: ceatedBook })
    } catch (err) {
...
const getBooks = async function (req, res) {
    try {
        ...
        const bookDetails = bookData.sort(function (a, b) { a['title'].toLowerCase() < b['title'].toLowerCase() ? 1 : -1 })
...
const getBooksById = async function (req, res) {
    ...
    const book = { _id, reviews, title, excerpt, userId, ISBN, category, subcategory, reviewsData: reviewData, releasedAt, deletedAt, isDeleted, updatedAt, createdAt }
